        ...
        <div>
            <table class="auto-style1">
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server">Agregar Sucursal</asp:HyperLink>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style3">
                        <asp:HyperLink ID="HyperLink2" runat="server">Lisatado de Sucursales</asp:HyperLink>
                    </td>
                    <td>&nbsp;</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnMostrarTodos" runat="server" Text="Motrar todos" />
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
